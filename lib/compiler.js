...
Compiler.prototype.buildTscArguments = function (version) {
  ...
  if (this.options.moduleResolution)  args.push('--moduleResolution', this.options.moduleResolution.toLowerCase());
  ...
  if (this.options.inlineSources)     args.push('--inlineSources');
